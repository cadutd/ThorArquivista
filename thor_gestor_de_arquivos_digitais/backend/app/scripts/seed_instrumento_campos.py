...
def build_seed_data() -> list[InstrumentoCampoSeed]:
    return [
        ...
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-GUIA-ACESSO-DIGITAL",
            nome="Identificador do pacote",
            chave="identificador_pacote",
            tipo=TipoCampoInstrumento.TEXTO_CURTO,
            ordem=0,
            obrigatorio=True,
            filtro_avancado=True,
        ...
        InstrumentoCampoSeed(
            ...
            facetavel=True,
            opcoes=[
                {"valor": "PUBLICO", "rotulo": "Publico"},
                {"valor": "INTERNO", "rotulo": "Interno"},
                {"valor": "RESTRITO", "rotulo": "Restrito"},
            ],
        ),
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-INVENTARIO-AUDIOVISUAL",
            nome="Titulo do item",
            chave="titulo_item",
            tipo=TipoCampoInstrumento.TEXTO_CURTO,
            ordem=0,
        ...
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-INVENTARIO-AUDIOVISUAL",
            nome="Suporte audiovisual",
            chave="suporte_audiovisual",
            tipo=TipoCampoInstrumento.LISTA_SIMPLES,
            ordem=1,
            filtro_avancado=True,
            facetavel=True,
            opcoes=[
                ...
                {"valor": "ARQUIVO_DIGITAL", "rotulo": "Arquivo digital"},
            ],
        ),
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-INVENTARIO-AUDIOVISUAL",
            ...
            aparece_busca=False,
            validacoes={"pattern": "^\\d{2}:\\d{2}:\\d{2}$"},
        ),
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-CATALOGO-MAPAS",
            nome="Titulo cartografico",
            chave="titulo_cartografico",
            tipo=TipoCampoInstrumento.TEXTO_CURTO,
            ordem=0,
            obrigatorio=True,
            filtro_avancado=True,
        ...
        InstrumentoCampoSeed(
            ...
            ordem=1,
            placeholder="1:10000",
            validacoes={"max_length": 80},
        ),
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-CATALOGO-MAPAS",
            nome="Imagem digital",
            chave="imagem_digital",
            tipo=TipoCampoInstrumento.IMAGEM,
            ordem=2,
            aparece_listagem=False,
            aparece_busca=False,
        ...
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-INDICE-ASSUNTOS",
            nome="Termo principal",
            chave="termo_principal",
            tipo=TipoCampoInstrumento.TEXTO_CURTO,
            ordem=0,
            obrigatorio=True,
            filtro_avancado=True,
        ...
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-BASE-DIREITOS-HUMANOS",
            nome="Caso",
            chave="caso",
            tipo=TipoCampoInstrumento.TEXTO_CURTO,
            ordem=0,
        ...
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-BASE-DIREITOS-HUMANOS",
            nome="Grau de sensibilidade",
            chave="grau_sensibilidade",
            tipo=TipoCampoInstrumento.LISTA_SIMPLES,
            ordem=1,
            obrigatorio=True,
            filtro_avancado=True,
        ...
        InstrumentoCampoSeed(
            instrumento_codigo="TEST-INST-BASE-DIREITOS-HUMANOS",
            nome="Resumo protegido",
            chave="resumo_protegido",
            tipo=TipoCampoInstrumento.TEXTO_LONGO,
            ordem=2,
            aparece_listagem=False,
        ),
